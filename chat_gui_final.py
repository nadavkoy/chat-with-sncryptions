...
class UserEntrancePanel(wx.Panel):
    ...
    def wait_for_server_verification(self, event):
        ...
        if self.parent_frame.get_entrance_type() == 'login':
            ...
            print message, len(message), len(self.parent_frame.client.encrypt_request(message))
            self.parent_frame.client.client_socket.send(self.parent_frame.client.encrypt_request(message).ljust(1024, '0'))
    ...
    def server_verification(self):
        ...
        server_response = self.parent_frame.client.decrypt_response(server_response).split('0')[0]
        print "res1 " + server_response
...
class ChatPanel(wx.Panel):
    ...
    def receive_messages(self):
        ...
        while True:
            ...
            message_received = self.parent_frame.client.decrypt_response(message_received).split('0')[
                    0]  # receiving message.
